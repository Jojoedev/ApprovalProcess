...
namespace ApprovalProcess.Data.Migrations
{
    ...
    [Migration("20230829035339_FirstApproverDB")]
    partial class FirstApproverDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApprovalProcess.Models.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ApprovalProcess.Models.Request", b =>
                {
                    ...
                    b.HasOne("ApprovalProcess.Models.FirstApprover", "FirstApprover")
                        .WithMany()
                        .HasForeignKey("FirstApproverId");

                    b.HasOne("ApprovalProcess.Models.Status", "Status")
                        .WithMany()
